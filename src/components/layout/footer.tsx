...
export function Footer() {
  return (
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-background)] py-12 mt-24">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold tracking-tighter mb-2">
              {siteConfig.name}<span className="text-[var(--color-primary)]">.</span>
            </h3>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-[var(--color-text)]">Quick Links</h4>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-[var(--color-text)]">Connect</h4>
            <ul className="flex flex-col gap-2">
              <li>
                <a
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-[var(--color-muted)] hover:text-[#0A66C2] transition-colors flex items-center gap-2"
                >
              ...
              <li>
                <a
                  ...
                  className="text-sm text-[var(--color-muted)] hover:text-[#EA4335] transition-colors flex items-center gap-2"
                >
                  <Mail size={16} /> Email
                </a>
              </li>
